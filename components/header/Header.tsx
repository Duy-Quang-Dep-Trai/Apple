...
// import StoreRibbon from "../ribbon/StoreRibbon";
...
const navItems = [
    ...
    { label: "iPad", key: "ipad", hasDropdown: true },
    { label: "iPhone", key: "iphone", hasDropdown: true },
...
type OpenKey = "store" | "mac" | "ipad" | "iphone" | null;
    ...
    return (
        <header className="sticky top-0 z-50 relative">
            ...
            <div onMouseEnter={cancelClose} onMouseLeave={() => scheduleClose(closeAll, 120)}>
                ...
                {/* ✅ Ribbon nằm ngay dưới nav, remount theo pathname để chạy lại animation khi đổi link */}
                {/*
        <StoreRibbon key={pathname} />
        */}
